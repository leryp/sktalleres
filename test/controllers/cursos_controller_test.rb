...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { back_img: @curso.back_img, contenido: @curso.contenido, descripcion: @curso.descripcion, dirigido_a: @curso.dirigido_a, nombre: @curso.nombre }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { back_img: @curso.back_img, contenido: @curso.contenido, descripcion: @curso.descripcion, dirigido_a: @curso.dirigido_a, nombre: @curso.nombre }
    assert_redirected_to curso_path(assigns(:curso))
  end
